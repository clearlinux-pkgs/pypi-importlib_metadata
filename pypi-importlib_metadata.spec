...
Source0  : https://files.pythonhosted.org/packages/35/a8/f2bd0d488c2bf932b4dda0fb91cbb687c0b1132b33130d1cfad4e2b4b963/importlib_metadata-4.11.4.tar.gz
...
%prep
%setup -q -n importlib_metadata-4.11.4
cd %{_builddir}/importlib_metadata-4.11.4
%patch1 -p1
pushd ..
cp -a importlib_metadata-4.11.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653336791
...
cp %{_builddir}/importlib_metadata-4.11.4/LICENSE %{buildroot}/usr/share/package-licenses/pypi-importlib_metadata/da4dc954bbc3ab0893517cb1d7af5598f7a3daf4
